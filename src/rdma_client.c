...
static int client_prepare_connection(struct sockaddr_in *s_addr)
{
    ...
    qp_init_attr.cap.max_recv_sge = MAX_RECV_SGE; /* Maximum SGE per receive posting */
    qp_init_attr.cap.max_recv_wr = MAX_WR; /* Maximum receive posting capacity */
    qp_init_attr.cap.max_send_sge = MAX_SEND_SGE; /* Maximum SGE per send posting */
...
static int client_xchange_metadata_with_server()
{
	...
	client_send_sge.lkey = (uint32_t) client_metadata_mr->lkey;
